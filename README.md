# Enterprise Knowledge Assistant using RAG and Local LLMs

[![CI](https://github.com/Kunalchandra007/Enterprise-Knowledge-Assistant-using-RAG-and-Local-LLMs/workflows/CI/badge.svg)](https://github.com/Kunalchandra007/Enterprise-Knowledge-Assistant-using-RAG-and-Local-LLMs/actions/workflows/ci.yaml)
...
The Enterprise Knowledge Assistant works by taking a collection of Markdown files as input and, when asked a question, provides the
...
When a user asks a question, the Enterprise Knowledge Assistant retrieves the most relevant sections from the Embedding database.
...
## Run the Enterprise Knowledge Assistant

The Enterprise Knowledge Assistant has a UI built with `Vite`, `React` and `TypeScript`, and a backend built with `FastAPI` that serves the LLMs through `llama.cpp` server.
